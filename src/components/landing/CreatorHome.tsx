  ...
  return (
    <CosmicScene><div className="creator-home">
      ...
      <section id="projects" className="hub-width projects-section">
        ...
        <div className="project-shelf home-project-shelf">{creator.projects.filter(project => ['echo-scribe', 'growthinator', 'glue-paste-dev', 'ill-be-back'].includes(project.slug)).map(project => <ProjectCard key={project.slug} project={project} locale={locale} />)}</div>
